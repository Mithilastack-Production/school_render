...
import { createImageGallery, deleteImageGallery, getImageGallery, updateActivity, updateImageGallery } from "../../http";
...
export default function ImageGallery() {
    ...
    useEffect(() => {
        async function getLink() {
            setLoading(true);
            try {
                const req = await getImageGallery();
                setLinks(req.data);
            } catch (e) {
    ...
    return (
        <Section innerBackgroundColor="lightblue" sectionName={"Image Gallery"}>
            <SectionWrapper>
                <FormContainer>
...
function MyInnerComponent({
    ...
    async function createNewLink() {
        ...
        try {
            ...
            const req = await createImageGallery({ text, image });
            setText("");
    ...
    async function updateLink() {
        ...
        try {
            ...
            const res = await updateImageGallery(item?._id, {
                text,
                image,
            });
    ...
    async function deleteLink() {
        ...
        setLoading(true);
        try {
            await deleteImageGallery(item?._id);
            removeLink(item);
