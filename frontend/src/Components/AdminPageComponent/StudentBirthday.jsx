...
function MyInnerComponent({
    ...
    const verifyAndSendDataToServer = () => {
        ...
        if (!classOfStudent) {
            toast("Class of Student cannot be empty");
            return false;
        }
        if (!section) {
            toast("Section of Student cannot be empty");
            return false;
        }
        if (!message) {
    ...
    async function createNewLink() {
        ...
        try {
            ...
            const req = await createStudentBirthday({
                name,
                dob,
                classOfStudent,
                section,
    ...
    async function updateLink() {
        ...
        try {
            ...
            const res = await updateStudentBirthday(item?._id, {
                name,
                dob,
                classOfStudent,
                section,
    ...
    async function deleteLink() {
        ...
        setLoading(true);
        try {
            await deleteStudentBirthday(item?._id);
            removeLink(item);
    ...
    function changeEdit() {
        if (edit) {
            ...
            setClassOfStudent(item?.classOfStudent ?? "");
