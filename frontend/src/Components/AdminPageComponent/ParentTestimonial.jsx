...
import { createParentTestimonial, deleteParentTestimonial, getParentTestimonials, updateParentTestimonial } from "../../http";
...
export default function ParentTestimonial() {
    ...
    useEffect(() => {
        async function getLink() {
            setLoading(true);
            try {
                const req = await getParentTestimonials();
                setLinks(req.data);
            } catch (e) {
    ...
    return (
        <Section innerBackgroundColor="lightblue" sectionName={"Parent Testimonial"}>
            <SectionWrapper>
                <FormContainer>
...
function MyInnerComponent({
    ...
    async function createNewLink() {
        ...
        try {
            ...
            const req = await createParentTestimonial({ src });
            setSrc("");
    ...
    async function updateLink() {
        ...
        try {
            ...
            const res = await updateParentTestimonial(item?._id, {
                src
            });
    ...
    async function deleteLink() {
        ...
        setLoading(true);
        try {
            await deleteParentTestimonial(item?._id);
            removeLink(item);
