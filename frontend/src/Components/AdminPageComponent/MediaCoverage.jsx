...
import { createMediaCoverage, deleteMediaCoverage, getMediaCoverage, updateMediaCoverage } from "../../http";
...
export default function MediaCoverage() {
    ...
    useEffect(() => {
        async function getLink() {
            setLoading(true);
            try {
                const req = await getMediaCoverage();
                setLinks(req.data);
            } catch (e) {
    ...
    return (
        <Section innerBackgroundColor="lightblue" sectionName={"Media Coverage"}>
            <SectionWrapper>
                <FormContainer>
...
function MyInnerComponent({
    ...
    async function createNewLink() {
        ...
        try {
            ...
            const req = await createMediaCoverage({ text, image });
            setText("");
    ...
    async function updateLink() {
        ...
        try {
            ...
            const res = await updateMediaCoverage(item?._id, {
                text,
                image,
            });
    ...
    async function deleteLink() {
        ...
        setLoading(true);
        try {
            await deleteMediaCoverage(item?._id);
            removeLink(item);
