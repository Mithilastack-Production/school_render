...
import { createBlog, deleteBlog, getBlogs, updateBlog } from "../../http";
...
export default function Blog() {
    ...
    return (
        <Section innerBackgroundColor="lightblue" sectionName={"Blog"}>
            <SectionWrapper>
                <FormContainer>
...
function MyInnerComponent({
    ...
    async function updateLink() {
        ...
        try {
            ...
            const res = await updateBlog(item?._id, {
                title,
                subTitle,
                alt,
                image,
