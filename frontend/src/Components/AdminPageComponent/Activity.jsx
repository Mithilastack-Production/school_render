...
import { createActivity, deleteActivity, getActivities, updateActivity } from "../../http";
...
export default function Activity() {
    ...
    return (
        <Section innerBackgroundColor="lightblue" sectionName={"Activity"}>
            <SectionWrapper>
                <FormContainer>
...
function MyInnerComponent({
    ...
    async function createNewLink() {
        ...
        try {
            ...
            const req = await createActivity({ text, image });
            setText("");
    ...
    async function updateLink() {
        ...
        try {
            ...
            const res = await updateActivity(item?._id, {
                text,
                image,
            });
