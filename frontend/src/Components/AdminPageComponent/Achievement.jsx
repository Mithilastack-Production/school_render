...
export default function Achievement() {
    ...
    useEffect(() => {
        async function getLink() {
            setLoading(true);
            try {
                const req = await getAchievements();
                setLinks(req.data);
            } catch (e) {
    ...
    return (
        <Section innerBackgroundColor="lightblue" sectionName={"Achievement"}>
            <SectionWrapper>
                <FormContainer>
...
function MyInnerComponent({
    ...
    async function createNewLink() {
        ...
        try {
            ...
            const req = await createAchievement({
                title,
                subTitle,
                alt,
                image,
    ...
    async function updateLink() {
        ...
        try {
            ...
            const res = await updateAchievement(item?._id, {
                title,
                subTitle,
                alt,
                image,
